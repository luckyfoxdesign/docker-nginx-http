...
4. Запустит автообновление сертификата (certbot обновляет файлы, nginx сам подхватывает их reload'ом раз в 12 часов — без ручных действий и без даунтайма)
...
# Новый сертификат подхватывается автоматически раз в 12ч — руками нужно только после правки конфига
